...
\item \emph{Candidate paths} $\mathcal{P}_t$ and their validity masks\textcolor{red}{需要一句话解释一下validity masks}.
\end{enumerate}
...
\While{collected frames $<T$}{
  ...
  Update learning rate via cosine annealing\textcolor{red}{cosine annealing 的具体参数在实验部分有说明吗}\;
